...
const BOOK_URL_MAP = {
  // === Custom KG mappings (LightRAG injected books) ===
  'custom_kg': 'https://cpsglobal.org/books/peace-in-kashmir',
  'peace_in_kashmir': 'https://cpsglobal.org/books/peace-in-kashmir',
  'peace-in-kashmir': 'https://cpsglobal.org/books/peace-in-kashmir',
...
export function extractBookKey(filePath) {
  ...
  // Special case: LightRAG custom knowledge graph (Peace in Kashmir)
  if (filePath === 'custom_kg') {
    return 'peace_in_kashmir';
  }
