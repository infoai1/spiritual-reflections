...
export default function ShareButtons({ title, interpretation, url }) {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        className="p-2 rounded-full bg-[#25D366]/20 text-[#25D366] hover:bg-[#25D366]/30 transition-colors"
      ...
      <button
        ...
        className="p-2 rounded-full bg-[#1877F2]/20 text-[#1877F2] hover:bg-[#1877F2]/30 transition-colors"
